...
const url = "http://localhost:3000";
(0, _axiosDefault.default).get(url).then(({ data  })=>console.log(data)).catch((err)=>console.log(err));
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire14d2")
