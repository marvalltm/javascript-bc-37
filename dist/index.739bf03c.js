...
const userAPI = (0, _axiosDefault.default).create({
...
const getOneUser = function() {
    if (someID) return userAPI(`/user/${someID}`).then(({ data  })=>console.log(data.data));
    else throw new Error("not set ID");
};
const addUser = function() {
...
const updateUser = function() {
    if (someID) return userAPI.put(`/user/${someID}`, {
        login: "wwwww@admin.com",
        rules: "www"
    }).then(({ data  })=>console.log(data));
    else throw new Error("not set ID");
...
const patchUser = function() {
    if (someID) return userAPI.patch(`/user/${someID}`, {
...
const deleteUser = function() {
    if (someID) return userAPI.delete(`/user/${someID}`).then(({ data  })=>console.log(data));
    else throw new Error("not set ID");
};
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire14d2")
